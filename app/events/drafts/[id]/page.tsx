...
export function QuivyDashboard() {
              ...
              <CardContent className="p-6 flex justify-between items-start">
                <div>
                  ...
                  <div className="flex items-end gap-2">
                    <span className="text-4xl font-bold">{draftData?.clicks}</span>
            ...
            <Card className="bg-[#7340fd] text-white">
              <CardContent className="p-6 flex justify-between items-start">
                <div>
                  ...
                  <div className="flex items-end gap-2">
                    <span className="text-4xl font-bold">{draftData?.scans}</span>
            ...
            <Card className="bg-[#7340fd] text-white">
              <CardContent className="p-6 flex justify-between items-start">
                <div>
                  ...
                  <div className="flex items-end gap-2">
                    <span className="text-4xl font-bold">{draftData?.winners.length}</span>
          ...
          <TabsContent value="outline" className="mt-0">
            <div className="space-y-6">
              ...
              <div>
                ...
                <Input defaultValue={draftData?.name} className="border rounded-lg p-4" />
              </div>
              ...
              <div>
                ...
                <Textarea
                  defaultValue={draftData?.description}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <div className="relative">
                    <Input
                      type="text"
                      defaultValue={isMobile ? "Jan 15, 2025" : "January 09, 2025"}
                ...
                <div>
                  ...
                  <div className="relative">
                    <Input
                      type="text"
                      defaultValue={isMobile ? "01:00 PM" : "10:00 AM"}
                      className="border rounded-lg p-4 pr-10"
                    />
                ...
                <div>
                  ...
                  <div className="relative">
                    <Input
                      type="text"
                      defaultValue={isMobile ? "3h 0m" : "3h 30m"}
                      className="border rounded-lg p-4 pr-10"
                    />
              ...
              <p className="text-sm text-gray-500">
                ...
                {isMobile ? "January 15, 2025 from 01:00PM until 04:00PM" : "January 09, 2025 from 10:00 AM to 01:30PM"}
              </p>
