...
import Barcodeanim from "@/public/assets/animations/barcode"
import Heroanim from "@/public/assets/animations/hero"
      ...
      <header className="w-full min-h-[100dvh] flex flex-col md:flex-row justify-between items-center relative p-8">
        ...
        <article className="relative z-20 w-full h-full flex flex-col justify-center space-y-10">
          ...
          <div className="flex items-center w-fit h-auto">
            <Input
              type="text"
              className="rounded-full p-8 md:p-8 w-full md:w-[400px]"
              placeholder="&#9993; Your email address"
            />
            <Button
              variant="default"
              className="bg-quivyPurple rounded-full relative -left-8 md:-left-28 p-8 w-[350px] md:w-[250px]"
            >
              Create Event
            </Button>
          </div>
          <div className="flex space-x-4 items-center">
            <Button
              variant="default"
              className="flex items-center p-7 rounded-lg"
            >
        ...
        <section className="z-20 relative w-full flex flex-col items-center justify-between space-y-24 h-auto">
         <span className="p-2"> <Lottie options={heroLottieOptions} width={`${isMobile ? 300 : 400}`} height={`${isMobile ? 300 : 400}`} className="relative top-10"/> </span>
          ...
          <div className="flex flex-col md:flex-row justify-center items-center space-y-14 md:space-x-14">
            <Card className="bg-transparent flex flex-col items-center space-y-4 shadow-none border-none">
              ...
              <CardContent className="text-center space-y-3">
                <CardTitle className="font-semilbold text-lg">
                  Get Started
                </CardTitle>
